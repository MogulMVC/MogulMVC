// tip, facebook style tooltips for jquery
// version 1.0.0a
...
(function($) {
    ...
    $.fn.tip = function(options) {
        ...
        options = $.extend({}, $.fn.tip.defaults, options);
        
        function get(ele) {
            var tip = $.data(ele, 'tip');
            if (!tip) {
                tip = new Tip(ele, $.fn.tip.elementOptions(ele, options));
                $.data(ele, 'tip', tip);
            }
            return tip;
        }
     ...
     *        component.
     */
     $.fn.tip.autoBounds = function(margin, prefer) {
		return function() {
